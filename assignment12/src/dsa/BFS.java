...
public class BFS extends Graph.GraphAlgorithm<BFS.BFSVertex> {
    ...
    // Class to store information about vertices during dsa.BFS
    ...
    public static void main(String[] args) throws Exception {
		...
		// testcase string
		String string = "6 12   1 2 1   1 3 1   2 4 1   3 4 1   4 5 1   5 1 1   6 3 1   3 6 1   1 6 1   5 4 1   3 6 1   4 1 1 1";
		Scanner in;
		...
		// Create an instance of dsa.BFS and run bfs from source s
		BFS b = breadthFirstSearch(g, s);

		g.printGraph(true);

		System.out.println("Output of dsa.BFS:\nNode\tDist\tParent\n----------------------");
		for(Vertex u: g) {
